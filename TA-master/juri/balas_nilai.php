...
date_default_timezone_set("Asia/Jakarta");
    ...
    $query = mysqli_query($conn, "UPDATE karya SET nilai = '$nilai', tanggal_ditanggapi = '$tanggal_ditanggapi' WHERE id_karya=$id ");
    ...
    <div class="card shadow mb-4">
        ...
        <form action="" method="POST">
            ...
            <div class="form-group">
                <label></label>
                <textarea class="input message" cols="30" rows="5" autocomplete="off" name="nilai" placeholder="Balasan....." required></textarea>
            </div>
